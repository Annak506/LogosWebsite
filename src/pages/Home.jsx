...
export default function Home() {
  ...
  return (
    ...
    <div className="quote-container">
     ...
     <div className = "quote"> <p> Ik kwam hier om beter te leren schrijven, maar vertrok met zoveel meer. De sessies hielpen me niet alleen om mijn schrijfstijl te verfijnen, maar ook om mijn innerlijke wereld te verkennen en te verwerken. Het was een plek waar techniek en therapie naadloos samenkwamen. Heel inspirerend! <p className="names"> - Annemette, 32, Bonaire </p> </p> </div>
    </div>
